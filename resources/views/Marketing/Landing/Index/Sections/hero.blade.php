	...
	<div class="relative overflow-hidden">
			...
			<div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
				<div class="text-center">
					...
					<p class="mx-auto max-w-2xl block mt-12 text-3xl text-gray-800 rounded-md pb-2 pt-1">
						...
						<span class="bg-red-500 px-2 py-0.5 rounded text-white text-2xl font-medium">LIVE</span> 
						Streams too.
					</p>
				</div>
			</div>
		...
		<div>
			...
			<div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
				<h2 class="text-center text-gray-400 text-sm font-semibold uppercase tracking-wide">Works with all your favorite social video providers</h2>
				<div class="mt-4 grid grid-cols-2 gap-4 md:grid-cols-6 lg:grid-cols-5">
					<div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
						<img src="/img/logos/social/facebook-logo.svg" alt="Facebook">
					</div>
					<div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
						<img src="/img/logos/social/youtube-logo.svg" alt="YouTube">
					</div>
					<div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
						<img src="/img/logos/social/twitch-logo.svg" alt="Twitch">
					</div>
					<div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
						<img src="/img/logos/social/tiktok-logo.svg" alt="TikTok">
					</div>
					<div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
						<img class="pt-4" src="/img/logos/social/instagram-logo.svg" alt="Instagram">
					</div>
				</div>
			</div>
		</div>
